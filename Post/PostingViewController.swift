...
class PostingViewController : UIViewController{
    ...
    //let systemImageNameArray=["moon","cloud","smoke.fill", "tv.fill"]
    ...
    //   ----닙파일이랑 연결----
    //닙파일 연결시켜주기
    let PostingCustomCollectionViewCellNib = UINib(nibName: String(describing: PostingCustomCollectionViewCell.self), bundle: nil)
    
    //가져온 닙파일을 콜렉션뷰에 셀로 등록하기
    self.PostingCollectionView.register(PostingCustomCollectionViewCellNib, forCellWithReuseIdentifier: String(describing: PostingCustomCollectionViewCell.self))
